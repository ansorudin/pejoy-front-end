                            ...
                            <div className="px-4 pt-3 pb-3 border">
                                {
                                    this.state.imagePreviewURL?
                                        <img src={this.state.imagePreviewURL} alt="Image Preview" width="100%" />
                                    :
                                        <>
                        ...
                        <div className="col-12 col-md-6 px-3 py-3">
                            <div className="px-0 pt-0 pb-1">
                                ...
                                <div className="row pt-1">
                                                ...
                                                return(
                                                    <div key={index} className="col-12 row mx-0 px-0">
                                                        <div className="col-8 py-2 border border-top-0 border-right-0">
                                                            <span>{value.product_name}<span className="font-weight-bold"> ( x{value.qty} )</span></span>
                                                        </div>
                                    ...
                                    <div className="col-4 py-2 border border-top-0">
                                        {this.state.data? 'Rp.' + (this.state.data[0].shipping_rates).toLocaleString('id-ID') : <Loader type="ThreeDots" color="#005eb8" height={30} width={30} />}
                                    </div>
                                    <div className="col-8 py-2 border border-top-0 border-right-0">
                                    ...
                                    <div className="col-4 py-2 border border-top-0">
                                        {this.state.data? 'Rp.' + (this.state.data[0].total_amount + 495).toLocaleString('id-ID') : <Loader type="ThreeDots" color="#005eb8" height={30} width={30} />}
                                    </div>
                                </div>
                            </div>
